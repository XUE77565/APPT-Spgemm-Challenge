...
def main():
    ...
    methods = [("Ocean", "#4a3aa7"), ("HSMU", "#1baf7a"), ("cuSPARSE", "#898781"),
               ("merge(serial)", "#c98a1e"), ("merge3", "#e0533d"), ("Auto", "#2a78d6")]
    # CSV 列名 → 显示名
    colmap = {"Ocean": "Ocean", "HSMU": "HSMU", "cuSPARSE": "cu",
              "merge(serial)": "serial", "merge3": "merge3", "Auto": "Auto"}
