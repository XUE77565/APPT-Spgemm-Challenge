#!/usr/bin/env python3
"""v25(DCFUSE)干净分析:vs v9 Ocean 列的 geomean/赢面/带结构/相对 v23 的变化。"""
import csv, math, sys
...
print(f"可比 {len(pairs)} 阵:geomean v25 = {gm([p[3] for p in pairs]):.4f}×  "
